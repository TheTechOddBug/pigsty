...
[![License: Apache-2.0](https://img.shields.io/github/license/pgsty/pigsty?logo=opensourceinitiative&logoColor=green&color=slategray)](https://pigsty.cc/docs/about/license/)
...
Pigsty is licensed under [Apache-2.0](LICENSE). 
Two **optional** modules (`INFRA` and `MINIO`) are licensed under [AGPL-3.0](https://www.gnu.org/licenses/agpl-3.0.html) due to upstream dependencies (Grafana & MinIO). See [NOTICE](NOTICE) for details.  
